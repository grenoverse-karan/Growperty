        ...
        >
          <Card className="rounded-3xl shadow-xl border-border/50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl">
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <Button type="button" variant="outline" onClick={() => { window.location.href = '/api/auth/signin/google?callbackUrl=' + encodeURIComponent(window.location.origin); }} className="w-full h-12 rounded-xl font-bold border-border/60 hover:bg-slate-50 dark:hover:bg-slate-800">
